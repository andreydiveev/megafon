...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'small_image',array('size'=>60,'maxlength'=>1024)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'large_image'); ?>
		<?php echo $form->textField($model,'large_image',array('size'=>60,'maxlength'=>1024)); ?>
	</div>
